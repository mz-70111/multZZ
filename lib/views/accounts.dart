              ...
              children: [
                Switch(
                    ...
                    onChanged: (x) => mainController.changeswitchvalue(
                        list: bodieslistofadd[1]['bp'][0], val: 'admin', x: x)),
            ...
            Row(
              children: [
                ...
                Text(bodieslistofadd[1]['bp'][0]['enable'] == true
                    ? ['حساب فعال', 'enabled account'][BasicInfo.indexlang()]
                    : ['حساب معطل', 'disabled account'][BasicInfo.indexlang()]),
              ],
            ),
            Row(
              children: [
            ...
            Row(
              children: [
                Switch(
                    ...
                    onChanged: (x) => mainController.changeswitchvalue(
                        list: bodieslistofadd[1]['bp'][0], val: 'pbx', x: x)),
                Text([
              ...
              child: DropDownWithSearchMz(
                ...
                ontap: (it) {
                  return setpreivileges(
                      ee: it, ctx: context, index: addtoofficelist.indexOf(it));
                },
              ),
            )
          ],
