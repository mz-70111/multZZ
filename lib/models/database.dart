...
begin_acceptcost_user int(11),
foreign key (begin_acceptcost_user) references users(user_id),
final_acceptcost_date TIMESTAMP NULL DEFAULT NULL,
begin_acceptcost_date TIMESTAMP NULL DEFAULT NULL,
final_acceptcost tinyint(1),
final_acceptcost_user int(11),
foreign key (final_acceptcost_user) references users(user_id),
